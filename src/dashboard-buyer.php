        ...
        <div class="max-w-7xl mx-auto px-4 py-8">
            ...
            <div class="text-center mb-12">
                ...
                <p class="text-xl text-slate-300 max-w-3xl mx-auto">
                    Browse verified scrap materials from trusted sellers across Australia
                </p>
            </div>
            ...
            <div class="mt-12 flex justify-center">
                <div class="inline-flex rounded-md shadow-sm">
                    <button class="px-4 py-2 bg-slate-800/50 border border-slate-700/50 text-slate-300 rounded-l-lg hover:bg-slate-700/50">
                        Previous
                    </button>
                    <button class="px-4 py-2 bg-emerald-600 border border-emerald-600 text-white">
                        1
                    </button>
                    <button class="px-4 py-2 bg-slate-800/50 border border-slate-700/50 text-slate-300 hover:bg-slate-700/50">
                        2
                    </button>
                    <button class="px-4 py-2 bg-slate-800/50 border border-slate-700/50 text-slate-300 hover:bg-slate-700/50">
                        3
                    </button>
                    <button class="px-4 py-2 bg-slate-800/50 border border-slate-700/50 text-slate-300 rounded-r-lg hover:bg-slate-700/50">
                        Next
                    </button>
                </div>
            </div>
